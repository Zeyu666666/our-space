...
function updateText() {
    ...
    document.getElementById('title').innerText = (currentLang === 'en' ? "Our Journey" : "我们的旅程");
    document.getElementById('label').innerText = (currentLang === 'en' ? "Days Together" : "在一起的天数");
    document.getElementById('subtext').innerText = (currentLang === 'en' ? "Since August 17, 2024" : "始于 2024年8月17日");
